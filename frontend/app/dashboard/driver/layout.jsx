...
export default function DriverLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Assigned Trips', href: '/dashboard/driver/assigned-trips', icon: Calendar },
    { name: 'Trip Report', href: '/dashboard/driver/trip-report', icon: FileText },
    { name: 'Maintenance', href: '/dashboard/driver/maintenance', icon: Truck },
